...
public class test {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Application Manager Cadres");
            System.out.println("Enter 1: To insert Cadres");
            System.out.println("Enter 2: To search Cadres by name: ");
            System.out.println("Enter 3: To show information Cadres");
                ...
                case "1": {
                    ...
                    switch (type) {
                        case "a": {
                            ...
                            Cadres engineer = new Engineer(name, age, gender, address, branch);
                        ...
                        case "c": {
                            ...
                            Cadres staff = new Staff(name, age, gender, address, task);
