...
public class StaffView {
    ...
    public void launcher1() {
        while (true) {
            ...
            System.out.println("                                                           ║       Trang thông tin nhân viên            ║");
            System.out.println("                                                           ║      1. Xem thông tin cá nhân              ║");
            System.out.println("                                                           ║      2. Hiển thị tổng số thời gian làm việc║");
            System.out.println("                                                           ║     trong 1 tháng                          ║");
            System.out.println("                                                           ║      3. Tính lương giờ làm                 ║");
            System.out.println("                                                           ║      4.Tính lương tăng ca                  ║");
            System.out.println("                                                           ║      5. Tổng lương phải trả                ║");
            System.out.println("                                                           ║      6. Mức Lương cơ bản                   ║");
            System.out.println("                                                           ║      0. Quay lại                           ║");
            System.out.println("                                                           ╚════════════════════════════════════════════╝");
            System.out.print("mời chọn chức năng: ");
            int actionMenu = Integer.parseInt(scanner.nextLine());
